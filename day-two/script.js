...
const threes = counts.filter(obj => Object.values(obj).includes(3)).length;
const twos = counts.filter(obj => Object.values(obj).includes(2)).length;
